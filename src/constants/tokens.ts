...
export const CAKE: { [chainId: number]: Token } = {
  [ChainId.BSC]: new Token(ChainId.BSC, '0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82', 18, 'CAKE', 'PancakeSwap Token'),
  [ChainId.BSCT]: new Token(ChainId.BSCT, '0xa35062141Fa33BCA92Ce69FeD37D0E8908868AAe', 18, 'CAKE', 'PancakeSwap Token')
}
export const BUSD: { [chainId: number]: Token } = {
  [ChainId.BSC]: new Token(ChainId.BSC, '0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56', 18, 'BUSD', 'Binance USD'),
  [ChainId.BSCT]: new Token(ChainId.BSCT, '0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee', 18, 'BUSD', 'Binance USD')
}
...
export const BTCB = new Token(ChainId.BSC, '0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c', 18, 'BTCB', 'Binance BTC')
...
export const MBF = new Token(ChainId.BSC, '0xe2997ae926c7a76af782923a7fef89f36d86c98f', 9, 'MBF', 'Moonbear.finance')
...
const tokens = {
  ...
  mbf: {
    symbol: 'MBF',
    address: {
      56: '0xe2997ae926c7a76af782923a7fef89f36d86c98f',
      97: ''
    },
    decimals: 9,
    projectLink: 'https://moonbear.finance/'
  },
  cake: {
    symbol: 'CAKE',
    address: {
